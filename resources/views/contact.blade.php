...
<header>
  <!-- Jumbotron -->
  <div class="text-center text-gray-800 py-20 px-6" style="height:'800px'; background-position:center">
    <h1 class="text-5xl font-bold mt-0 mb-6 mt-6 pt-8 pb-8">Contact Us </h1>
...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800">
    ...
    <div class="relative overflow-hidden bg-no-repeat bg-cover"
      style="background-position: 50%; background-image: url('/img/progressiveForumLogo.jpeg'); height: 750px;">
    </div>
