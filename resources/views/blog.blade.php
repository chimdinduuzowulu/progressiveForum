...
@section('content')
  ...
  <!-- Jumbotron -->
  <div class="text-center bg-gray-50 text-gray-800 py-44 px-8">
    <h1 class="text-5xl font-bold mt-0 mb-6">Blog </h1>
...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800 text-center">
    ...
    <h2 class="text-3xl font-bold mb-12 text-center">Latest Blog</h2>
    ...
    <div class="grid lg:grid-cols-3 gap-6 xl:gap-x-12">
      <div class="mb-6 lg:mb-0">
        <div>
          ...
          <h5 class="text-lg font-bold mb-3">Progressive Forum</h5>
